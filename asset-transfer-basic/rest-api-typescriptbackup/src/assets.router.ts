...
assetsRouter.post(
  ...
  body('contractID', 'must be a string').isString(),
  body('contractor', 'must be a string').isString(),
  body('contractee', 'must be a string[]').isArray(),
  body('contractee.*', 'must be a string').isString(),
  body('contractName', 'must be a string').isString(),
  async (req: Request, res: Response) => {
    ...
    const mspId = req.user as string;
    const assetId = req.body.contractID;
...
assetsRouter.put(
  ...
  async (req: Request, res: Response) => {
    ...
    if (req.params.assetId != req.body.contractID) {
      return res.status(BAD_REQUEST).json({
        status: getReasonPhrase(BAD_REQUEST),
    ...
    const mspId = req.user as string;
    const assetId = req.params.contractID;
